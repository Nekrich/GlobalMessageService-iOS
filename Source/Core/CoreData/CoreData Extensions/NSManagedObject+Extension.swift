...
internal extension NSManagedObjectSearchable where Self: NSManagedObject {
  ...
  private static var entityName: String? {
    ...
    if let entityName = entityNames[className] {
      ...
      let managedObjectModel = GlobalMessageServiceCoreDataHelper.managedObjectModel
    ...
    -> NSManagedObject? // swiftlint:disable:this opening_brace
  {
    ...
    let moc = managedObjectContext ?? GlobalMessageServiceCoreDataHelper.newManagedObjectContext()
