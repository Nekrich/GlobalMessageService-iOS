//
//  GlobalMessageService+SettingsOnTopLevel.swift
//  Pods
//
...
private extension GlobalMessageService {
...
internal extension GlobalMessageService {
	...
	static var registeredUser: GlobalMessageServicesSubscriber? {
		set {
...
public extension GlobalMessageService {
  ...
  /// Subscriber's phone number
	internal static var registeredUserPhone: Int64? {
    set {
