//
//  GlobalMessageServiceGMSDelegate.swift
...
public extension GlobalMessageService {
  /// An instance of `GlobalMessageServiceGoogleCloudMessagingHelper` 
  public static weak var googleCloudMessagingHelper: GlobalMessageServiceGoogleCloudMessagingHelper? = .None
 ...
 */
public protocol GlobalMessageServiceGoogleCloudMessagingHelper: class {
  ...
  /** 
   ...
   didRegisterForRemoteNotificationsWithDeviceToken deviceToken: NSData)`
   Setted automatically by `GlobalMessageService.framework`
   */
  var deviceToken: NSData? { get }
  
}

public extension GlobalMessageServiceGoogleCloudMessagingHelper {
